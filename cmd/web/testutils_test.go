...
import (
	...
	"snippetbox.kieransweeden.dev/internal/models/mocks"
)
...
func extractCSRFToken(t *testing.T, body string) string {
	// Note that matches is an array with the entire matched pattern in the
	...
	// Token is base64 string, thus could include '+' character.
	// We're using UnescapeString to ensure any precense of "&#43;"
	// is turned back to '+'.
