...
import (
	...
	"snippetbox.kieransweeden.dev/internal/validator"
)
...
func (app *application) userLogoutPost(w http.ResponseWriter, r *http.Request) {
	// Change session ID as there's been a privilege change within the session
	err := app.sessionManager.RenewToken(r.Context())
	if err != nil {
		app.serverError(w, r, err)
		return
...
func (app *application) accountPasswordUpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		if errors.Is(err, models.ErrInvalidCredentials) {
			form.AddFieldError("currentPassword", "The password entered is incorrect")
			data := app.newTemplateData(r)
			data.Form = form
			app.render(w, r, http.StatusUnprocessableEntity, "password.tmpl", data)
		} else {
	...
	app.sessionManager.Put(r.Context(), "flash", "You've updated your password successfully!")
